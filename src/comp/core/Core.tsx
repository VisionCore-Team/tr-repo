...
export default function Blog() {
  ...
  return (
    <div className="blog-page">
      ...
      {/* Bize Ulaşın Kutusu */}
      <SlideIn delay={0.6} duration={0.8}>
        <div
          className="page-root contact-section text-white p-8 mt-16 rounded-md border-[1px] border-gray-500 bg-black shadow-lg text-center flex flex-col justify-center items-center"
          style={{
            width: '100%',
