import my_img1 from "../../../public/img/veyselselimozturk.jpg";
  ...
  <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-16 lg:my-0">
    ...
    >
      ...
      <div
        ...
        <h1 className="text-3xl font-bold pt-8 lg:pt-0">Veysel OZTURK</h1>
        ...
        <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
            ...
            technology and programming, I have immersed myself in the world of 
            web development, focusing particularly on React.js.
            Beyond my academic pursuits, I actively seek opportunities to expand
            my knowledge and skills in this field, constantly experimenting 
            with new technologies and frameworks to stay at the forefront of industry trends.
            </p>
