...
const translations: Translation = {
  tr: {
    ...
    licenseplate_solutionProblemText: "Mercedes-Benz yetkili servis merkezleri araç takibi ve personel iletişimi konusundaki zorluklar nedeniyle karlılığında düşüş yaşıyordu. Servis alanındaki araçların verimsiz izlenmesi, onarım ve teslimat süreçlerinde gecikmelere yol açarak operasyonel verimliliği ve müşteri memnuniyetini olumsuz etkiliyordu.Ayrıca, farklı personel seviyeleri arasındaki yetersiz iletişim, operasyonel aksamalara ve daha fazla kazancın önünde engel yaratarak şirketin karlılığını daha da düşürüyordu.",
    licenseplate_solutionSolutionText: "Servis alanındaki araçların anlık ve verimli bir şekilde izlenmesi için gelişmiş bir gerçek zamanlı araç takip sistemi geliştirdik. Bu sistem, araçların tüm servis alanı içerisinde konumlarını ve durumlarını anında izlemeyi sağladı. Kullanıcı dostu arayüzümüz sayesinde tüm personel gerçek zamanlı bilgilere kolayca erişebildi. En önemlisi, bu iyileştirmeler karlılığı %40 oranında artırmamıza olanak sağladı.",
    ...
    health_paragraphTitle: "Sağlıkta Verimlilik ve Güvenlik VisionCore ile",
    health_paragraph: "Bilgisayarla görme teknolojisi, sağlık süreçlerine yeni bir boyut kazandırarak, hasta kabulünden tedaviye kadar verimliliği ve güvenliği artırır. Mevcut kamera sistemlerinizi kullanarak, fiziksel çevredeki nesneleri ve durumları hızlı ve doğru bir şekilde tespit etmenize olanak tanır. Bu sayede, süreçlerinizi gerçek zamanlı, özelleştirilmiş verilerle otomatikleştirerek operasyonel etkinliği maksimize edebilirsiniz. Sağlık kuruluşlarının karşılaştığı en zorlu problemleri ele alan kapsamlı bir çözüm sunuyoruz.",
    ...
    health_solution1Problem1Text: "Beyin hastalıklarını teşhis ve tedavi etmede, farklı beyin bölgelerini doğru bir şekilde belirlemek ve boyutlarını nicelendirerek ölçmek kritik öneme sahiptir.",
    ...
    health_solution2Problem2Title: "Yüksek İşlem Hızı Gereksinimleri",
    health_solution2Problem2Text: "Büyük miktarda örneği verimli bir şekilde işlemek için hızlı analiz yapılması gerekmektedir.",
    health_solution2Solution1Title: "Doğru Hücre Sayımı",
    health_solution2Solution1Text: "Beyaz kan hücrelerinin manuel sayımı iş gücü gerektirir ve insan hatasına açıktır.",
    health_solution2Solution2Title: "Yüksek İşlem Hızı Gereksinimleri",
    health_solution2Solution2Text: "Büyük miktarda örneği verimli bir şekilde işlemek için hızlı analiz gereklidir.",
    health_solution3Title: "AI Tabanlı Akciğer Segmentasyonu ve Lezyon Tespiti COVID-19 Teşhisi İçin",
    ...
    manufacture_paragraph: "Bilgisayarla görme, üretim süreçlerinizin üzerine ikinci bir göz olarak hizmet verir, üretkenliği ve güvenliği tüm değer zinciri boyunca artırır, malzeme takibinden üretim ve teslimata kadar her aşamada. VisionCore, mevcut kameraların, gerçek zamanlı verilerle spesifik ihtiyaçlara göre nesneleri hızlı bir şekilde tanıyıp yorumlamasını sağlar. Biz, üreticilerin en zorlayıcı sorunlarını çözen bir uçtan uca çözüme sahibiz.",
  ...
  en: {
    ...
    port_solution3SolutionText: "Automatic License Plate and Container Recognition: These systems instantly recognize and record vehicles and cargo entering and exiting port areas. Powered by artificial intelligence, these systems quickly and accurately detect license plates and container numbers, eliminating manual data entry errors. They facilitate the tracking of cargo and vehicle flow, optimize traffic management within the port, and prevent potential bottlenecks.",
