    ...
    <div className="project-container relative bg-cover bg-center scroll-mt-[124px] mt-20">
      <div className="lg:space-y-6">
        <FadeUp delay={0.2} duration={0.8}>
          <h2 className="mx-auto max-w-5xl px-6 text-white text-center text-2xl lg:text-6xl mb-8">
            {t("operations_heading")}
          </h2>
          <p className="mx-auto max-w-6xl px-6 text-gray-500 text-center text-base lg:text-xl">
            {t("operations_text")}
          </p>
        </FadeUp>
                ...
                <div className="z-10 flex h-full w-full flex-col rounded-lg transition-all text-white bg-[#0D1225]">
                  <div className="flex-1 items-center justify-center text-center flex w-full flex-col space-y-4 p-[16px]">
                    <div className="flex items-center">
                      <img src={el.source} alt={el.title} />
                    </div>
