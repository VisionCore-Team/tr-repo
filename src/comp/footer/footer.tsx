            ...
            <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
                <div className="md:flex md:justify-between max-md:flex max-md:flex-col max-md:items-center max-md: gap-5">
                    <div className="mb-6 md:mb-0 flex-column items-center justify-center">
                        <a onClick={() => nav("https://visioncore.com.tr/")} className="flex items-center">
                    ...
                    <div className="flex footerVerticalFlex gap-6">
                        <div className="footerBox">
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a onClick={() => nav("/solutions/byindustry/health")} className="hover:text-white">{t('health')}</a>
                                </li>
                                <li className="mb-4">
                                    <a onClick={() => nav("/solutions/byindustry/manufacturing")} className="hover:text-white">{t('manufacturing')}</a>
                                </li>
                                <li className="mb-4">
                                    <a onClick={() => nav("/solutions/byindustry/agriculture")} className="hover:text-white">{t('agriculture')}</a>
                                </li>
                                <li className="mb-4">
                                    <a onClick={() => nav("/*")} className="hover:text-white">Market Shelf Detection</a>
                                </li>
                                {/* <li className="mb-4">
                        ...
                        <div className="footerBox">
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a onClick={() => nav("/*")} className="hover:text-white">{t('policy')}</a>
                                </li>
                                <li>
                                    <a onClick={() => nav("/*")} className="hover:text-white">{t('terms')}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
