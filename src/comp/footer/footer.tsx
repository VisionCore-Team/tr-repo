          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a href="https://www.linkedin.com/company/visioncore" target="_blank" className="hover:underline">LinkedIn</a>
                      </li>
                  </ul>
...
>
  Whatsapp
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        © 2024 <a className="hover:text-blue-200" href="https://veyselozturk.com.tr">Veysel ÖZTÜRK</a> & <a className="hover:text-blue-200" href="https://caglarcakmak.com.tr">Çağlar ÇAKMAK</a>. All rights reserved.

        </div>

          <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a href="https://www.linkedin.com/company/visioncore" target="_blank" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              <FaLinkedin />
              </a>
